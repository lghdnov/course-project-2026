...
Управление выполняется посредством политик безопасности и бизнес-правил. Механизмами выступают Spring Boot приложение, PostgreSQL база данных, React frontend.
