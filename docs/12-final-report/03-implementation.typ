...
Бэкенд системы реализован на фреймворке Spring Boot @spring-boot-docs с использованием многослойной архитектуры и модульной организации по бизнес-фичам.
